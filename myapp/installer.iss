; Скрипт установщика DataSort Pro
; Создан с помощью Inno Setup

#define MyAppName "DataSort Pro"
...
begin
  WizardForm.WelcomeLabel2.Caption := 
    'Программа установит DataSort Pro на ваш компьютер.' + #13#10 + #13#10 +
    'DataSort Pro - это веб-приложение для сортировки и конвертации данных в форматах JSON, CSV и XML.' + #13#10 + #13#10 +
